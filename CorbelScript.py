...
volume_fraction_upper_bound = 0.35
number_of_elements = 25000
...
boundary_value_problem = available_boundary_value_problems["Corbel"]
...
polyplas_object = polyplas.PolyPlas(
    ...
    directory_name="CorbelResults_Case_A"
)
